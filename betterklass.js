  ...
  Class.extend = function(prop) {
    ...
    Klass.mixin = function(source){
      for (var prop in source) {
          Klass.prototype[prop] = source[prop];
          if( prop == 'mixed' && typeof source[prop] == 'function' ){
            source[prop](Klass);
          }
      }
    };

    Klass.include = function(source){
      for (var prop in source) {
          Klass[prop] = source[prop]; 
          if( prop == 'included' && typeof source[prop] == 'function' ){
            source[prop](Klass);
          }
      }
    };
...
var StaticModule = {
  propiedad: 'bla',
  included: function(){ console.log("Included"); }
};

var InstanceModule = {
  diHola: function(){ console.log("Hola"); },
  mixed: function(){ console.log("Mezclado"); }
};
